...
page = Nokogiri::HTML(open("http://annuaire-des-mairies.com/seine-et-marne.html"))

PAGE_URL = "http://annuaire-des-mairies.com/seine-et-marne.html"
...
class MailVille77
  ...
  def get_the_url(page) 
    url = page.chomp("seine-et-marne.html") 
    page = Nokogiri::HTML(open(page))
    municipalities = [] 
